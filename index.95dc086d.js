 ...
 * limitations under the License.
 */
class _t{getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}constructor(e){this.container=e}}const yt=new Ze("@firebase/app"),vt={"@firebase/app":"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},wt=new Map,bt=new Map;function It(e,t){try{e.container.addComponent(t)}catch(n){yt.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Et(e){const t=e.name;if(bt.has(t))return yt.debug(`There were multiple attempts to register component ${t}.`),!1;bt.set(t,e);for(const t of wt.values())It(t,e);return!0}function Tt(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _n{getToken(e){return this.auth_?this.auth_.getToken(e).catch((e=>e&&"auth/token-not-initialized"===e.code?(Xt("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(e))):new Promise(((t,n)=>{setTimeout((()=>{this.auth_?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then((t=>t.addAuthTokenListener(e)))}removeTokenChangeListener(e){this.authProvider_.get().then((t=>t.removeAuthTokenListener(e)))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',nn(e)}constructor(e,t,n){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=n,this.auth_=null,this.auth_=n.getImmediate({optional:!0}),this.auth_||n.onInit((e=>this.auth_=e))}}class yn{getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}constructor(e){this.accessToken=e}}yn.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Bt="9.9.0",Et(new We("database",((e,{instanceIdentifier:t})=>vo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Rt("@firebase/database","0.13.3",e),Rt("@firebase/database","0.13.3","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function ta(e,t,n=!1){if(n)return t;try{return await t}catch(t){throw t instanceof ye&&function({code:e}){return"auth/user-disabled"===e||"auth/user-token-expired"===e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var r,s;i.setAttribute("src",e),i.onload=t,i.onerror=e=>{const t=Ro("internal-error");t.customData=e,n(t)},i.type="text/javascript",i.charset="UTF-8",(null!==(s=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==s?s:document).appendChild(i)}))}function vl(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
vl("rcb"),new qo(3e4,6e4);async function wl(e,t,n){var i;const r=await n.verify();try{let s;if(Oo("string"==typeof r,e,"argument-error"),Oo("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){Oo("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wl=new qo(3e4,6e4);function Hl(){const e=cl().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Vl=null;function zl(e){return Vl=Vl||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){Hl(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Hl(),n(Ro(e,"network-request-failed"))},timeout:Wl.get()})}if(null===(r=null===(i=cl().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=cl().gapi)||void 0===s?void 0:s.load)){const t=vl("iframefcb");return cl()[t]=()=>{gapi.load?o():n(Ro(e,"network-request-failed"))},yl(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Vl=null,e}))}(e),Vl}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function(e=St()){const t=Tt(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Tt(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Ne(n.getOptions(),null!=t?t:{}))return e;So(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:tc,persistence:[_l,il,sl]})}();let oc;var ac,lc,cc;function hc(e){e.preventDefault();const t=document.querySelector("#name_1").value,n=document.querySelector("#email_1").value,i=document.querySelector("#password").value;!1!==pc(n)&&!1!==fc(i)?(Xa(sc,n,i).then((e=>{const i=e.user;go(po(rc,"users/"+i.uid),{username:t,email:n}),J(),O.reset(),alert("User Created")})).catch((function(e){e.code;const t=e.message;alert(t)})),oc=sc.currentUser):alert("Email or Password is Outta Line!")}function uc(e){e.preventDefault();const t=document.querySelector("#email_1").value,n=document.querySelector("#password").value;!1!==pc(t)&&!1!==fc(n)?(Za(sc,t,n).then((e=>{const t=e.user,n=new Date;mo(po(rc,"users/"+t.uid),{last_login:n}),J(),O.reset(),dc(),alert("User loged in")})).catch((e=>{e.code;const t=e.message;alert(t)})),oc=sc.currentUser):alert("Email or Password is Outta Line!")}function dc(){C&&k&&(C.classList.add("visually-hidden"),k.classList.remove("visually-hidden"))}function pc(e){return expression=/^[^@]+@\w+(\.\w+)+\w$/,!0===expression.test(e)}function fc(e){return!(e.length<6)}O&&O.addEventListener("submit",uc),q&&(q.onchange=function(){this.checked?(j.classList.remove("disabled_for_signUp"),j.removeAttribute("disabled")):(j.classList.add("disabled_for_signUp"),j.setAttribute("disabled","disabled"))}),W&&H.addEventListener("click",(function(){A.classList.add("visually-hidden"),P.classList.remove("visually-hidden"),D.classList.remove("visually-hidden"),B.classList.remove("visually-hidden"),$.classList.add("visually-hidden"),j.classList.remove("visually-hidden"),W.classList.add("visually-hidden"),V.classList.remove("visually-hidden"),O.addEventListener("submit",hc),O.removeEventListener("submit",uc)})),V&&z.addEventListener("click",(function(){A.classList.remove("visually-hidden"),P.classList.add("visually-hidden"),D.classList.add("visually-hidden"),B.classList.add("visually-hidden"),$.classList.remove("visually-hidden"),j.classList.add("visually-hidden"),W.classList.remove("visually-hidden"),V.classList.add("visually-hidden"),O.addEventListener("submit",uc),O.removeEventListener("submit",hc)})),ac=e=>{if(e){const t=e.uid;console.log(t),dc()}else C&&k&&(C.classList.remove("visually-hidden"),k.classList.add("visually-hidden"))},$e(sc).onAuthStateChanged(ac,lc,cc),K&&K.addEventListener("click",(e=>{el(sc).then((()=>{alert("User loged out")})).catch((e=>{e.code;const t=e.message;alert(t)}))}));var gc;gc=s("bRlFp");n(gc).defaults.baseURL="https://api.themoviedb.org/3";const mc=async()=>{const{data:e}=await n(gc).get("/genre/movie/list?api_key=119d79b053f922516c6af4b71b0fd3ac");return e},_c=a("genresList"),yc=({poster_path:e,popularity:t,vote_average:n,vote_count:i,original_title:r,genre_ids:s,overview:o})=>`\n<button class="modal__btn-closs btn__closs-modal">\n      <svg\n        xmlns="http://www.w3.org/2000/svg"\n        width="14"\n        height="14"\n        fill="currentColor"\n        class="bi bi-x-lg"\n        viewBox="0 0 16 16"\n      >\n        <path\n          d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"\n        />\n      </svg>\n    </button>\n<div class="modal__movi-poster">\n<img src="https://image.tmdb.org/t/p/w400/${e}" alt="placeholder" />\n</div>\n\n<div class="modal_movi-info">\n<h2 class="modal__title">${r}</h2>\n\n<div class="modal__info-card info-card">\n  <ul class="info-card__list-parametrs">\n    <li class="info-card__item info-card__item-paramter">Vote / Votes</li>\n    <li class="info-card__item info-card__item-point">\n      <span>${n.toFixed(1)}</span> <span>/</span> <span>${i}</span>\n    </li>\n    <li class="info-card__item info-card__item-paramter">Popularity</li>\n    <li class="info-card__item info-card__item-point">${t.toFixed(1)}</li>\n    <li class="info-card__item info-card__item-paramter">Original Title</li>\n    <li class="info-card__item info-card__item-point">${r}</li>\n    <li class="info-card__item info-card__item-paramter">Genre</li>\n    <li class="info-card__item info-card__item-point">${(e=>{const t=[];return e.map((e=>{_c.map((n=>{e===n.id&&t.push(n.name)}))})),t.join(", ")})(s)}</li>\n  </ul>\n  \n</div>\n\n<div class="modal__about">\n  <h3 class="modal__about-title">ABOUT </h3>\n  <p class="modal__about-text">\n    ${o}\n  </p>\n</div>\n<div class="modal__buttons">\n      <button type="button" class="modal__add-watched" data-watched='false' data-liery='false'>add to watched</button>\n      <button type="button" class="modal__add-queue" data-queue='false' data-liery='false'>add to queue</button>\n      \n    </div>\n   <div class='trailerBtnWrap'> <button class="trailerBtn"></button></div>\n  \n    </div>\n    </div>`;async function vc(){return{genres:await mc().then((({genres:e})=>e))}}function wc(e){vc().then((({genres:t})=>{o("genresList",t),e.results&&e.results.forEach((e=>{const{genre_ids:n,release_date:i}=e;t.forEach((({name:t,id:r})=>{n.includes(r)&&(n.length>2&&n.splice(2,n.length-1,"Other"),n.splice(n.indexOf(r),1,t)),e.genre_names=n.join(", "),e.release_date&&(e.release_date=i.slice(0,4))}))}));const n=bc(e.results);p&&(p.innerHTML=n)}))}function bc(e){if(e)return e.map((({original_title:e,poster_path:t,overview:n,vote_average:i,id:r,genre_names:s,release_date:o})=>`<li class='poster-list__item' key='${r}'>\n    <img\n      class='poster-list__img'\n      src='https://image.tmdb.org/t/p/w400${t}'\n      alt='${e}'\n      width\n      loading='lazy'\n    />\n    <span class='poster-list__rate'>${i.toFixed(1)}</span>\n    <div class='poster-list__wrap'>\n      <h2 class='poster-list__title'>${e}</h2>\n      <div class='poster-list__info'>\n        <p class='poster-list__text'>${s}</p>\n        <p class='poster-list__age'>| ${o}</p>\n      </div>\n    </div>\n  </li>`)).join("")}function Ic(e){vc().then((({genres:t})=>{o("genresList",t),e.results&&e.results.forEach((e=>{const{genre_ids:n,release_date:i}=e;t.forEach((({name:t,id:r})=>{n.includes(r)&&(n.length>2&&n.splice(2,n.length-1,"Other"),n.splice(n.indexOf(r),1,t)),e.genre_names=n.join(", "),e.release_date&&(e.release_date=i.slice(0,4))}))}));const n=bc(e.results);E&&(E.innerHTML=n)})),o("moviesData",e.results)}const Ec=document.querySelector(".btn--watched"),Tc=document.querySelector(".btn--queue");if(null!==Ec){Ec.addEventListener("click",(()=>{Cc("Watched")})),Tc.addEventListener("click",(()=>{Cc("Queue")}));const e=a("Watched")?a("Watched"):[],t=a("Queue")?a("Queue"):[];(t||e)&&t>e?document.addEventListener("DOMContentLoaded",(()=>{Cc("Queue")})):document.addEventListener("DOMContentLoaded",(()=>{Cc("Watched")}))}function Cc(e){"Queue"===e?(Tc.classList.add("btn-orange"),Ec.classList.remove("btn-orange")):(Tc.classList.remove("btn-orange"),Ec.classList.add("btn-orange")),E.classList.remove("list-empty"),E.innerHTML="";let t=e+"Data";const n=a(e);if(!n||!n.length)return function(e){const t=a(e)?a(e):[];if("Queue"===e?(Tc.classList.add("btn-orange"),Ec.classList.remove("btn-orange")):(Tc.classList.remove("btn-orange"),Ec.classList.add("btn-orange")),t){E.classList.add("list-empty");const t=`\n\t\t<div class='list-empty__shild blink'>\n\t\t\t<h3 class= 'list-empty__title'>Your ${n=e} list is empty!</h3>\n\t\t\t<p class='blink' >to add a movie to the ${n} list, click the corresponding button in the poster window</p>\n\t</div>`;E.innerHTML=t}var n}(e),console.log("ваш список пуст!");Ic({results:a(t)})}var kc;kc=JSON.parse('[{"name":"Maksim Yaroschuk","role":"Team Lead","git":"https://github.com/Maksim-Yaroschuk","img":"https://avatars.githubusercontent.com/u/79583144?v=4"},{"name":"Dmytro Kravchenko","role":"Scrum Master","git":"https://github.com/pixelboyXL","img":"https://avatars.githubusercontent.com/u/94831587?v=4"},{"name":"Eduard Tsikota","role":"Developer","git":"https://github.com/ts4ed","img":"https://avatars.githubusercontent.com/u/103256726?v=4"},{"name":"Andrey Tkachenko","role":"Developer","git":"https://github.com/TkachAn","img":"https://avatars.githubusercontent.com/u/61586895?v=4"},{"name":"Raya Shcherban","role":"Developer","git":"https://github.com/Raisiya","img":"https://avatars.githubusercontent.com/u/90385588?v=4"},{"name":"Dimitri Suhak","role":"Developer","git":"https://github.com/dimaniagara","img":"https://avatars.githubusercontent.com/u/86453739?v=4"},{"name":"Alina Marunchak","role":"Developer","git":"https://github.com/AlinaMrk","img":"https://avatars.githubusercontent.com/u/96976728?v=4"},{"name":"Denys Yeremenko","role":"Developer","git":"https://github.com/DenysYeremenko","img":"https://avatars.githubusercontent.com/u/95313654?v=4"},{"name":"Yevhenii Lymarenko","role":"Developer","git":"https://github.com/YevheniiLi","img":"https://avatars.githubusercontent.com/u/96422034?v=4"},{"name":"Yevhen Lytvynchuk","role":"Developer","git":"https://github.com/evglitik","img":"https://avatars.githubusercontent.com/u/95911893?v=4"},{"name":"Yevhen Chernytskyi","role":"Developer","git":"https://github.com/zhekichaan","img":"https://avatars.githubusercontent.com/u/100925349?v=4"}]');const Sc=async e=>{let t="";return await(async e=>{const{data:t}=await n(gc).get(`/movie/${e}/videos?api_key=119d79b053f922516c6af4b71b0fd3ac`);return t.results.filter((e=>{if("YouTube"===e.site)return e}))})(e).then((e=>t=`https://www.youtube.com/embed/${e[0].key}`)).catch((e=>t=!1)),t};async function Rc(e){const t=Number(e.target.getAttribute("key"));document.querySelector(".trailerBtn").setAttribute("disabled",!0),await Sc(t).then((e=>{e?(y.firstElementChild.insertAdjacentHTML("beforeend",`<iframe id="ytplayer" type="text/html" width="782" height="360"\n      src="${e}"\n      frameborder="0"/>`),document.querySelector("#ytplayer").scrollIntoView({block:"center",behavior:"smooth"})):(y.firstElementChild.insertAdjacentHTML("beforeend",'<div class="trailer-placeholder"></div>'),document.querySelector(".trailer-placeholder").scrollIntoView({block:"center",behavior:"smooth"}))}))}function Lc(e){const t=document.querySelector(".trailerBtn");t.setAttribute("key",e),t.addEventListener("click",Rc)}function Nc(e){const t=e.target.closest("li");if(t){const e=Number(t.getAttribute("key")),n=JSON.parse(localStorage.getItem("moviesData")).find((t=>t.id===e));!function(e){y.firstElementChild.innerHTML=yc(e)}(n),Dc(),document.querySelector("body").classList.contains("dark")?y.firstElementChild.classList.add("modal-dark"):y.firstElementChild.classList.remove("modal-dark"),y.firstElementChild.dataset.id=n.id,function(){const e=document.querySelector(".modal__add-watched"),t=document.querySelector(".modal__add-queue"),n=Number(y.firstElementChild.dataset.id);"library"===document.querySelector("body").getAttribute("data-weblocation")&&function(e,t){document.querySelector(".btn--watched").classList.contains("btn-orange")?(e.dataset.liery=!0,t.dataset.liery=!1):(e.dataset.liery=!1,t.dataset.liery=!0)}(e,t);null!==localStorage.getItem("Watched")&&Oc(n,e);null!==localStorage.getItem("Queue")&&Ac(n,t);e.addEventListener("click",(t=>{l(n,"Watched"),Pc(t,e,"Watched"),Oc(n,e)})),t.addEventListener("click",(e=>{l(n,"Queue"),Pc(e,t,"Queue"),Ac(n,t)}))}(),Lc(e)}}function Oc(e,t){if(null!==localStorage.getItem("Watched")){const n=localStorage.getItem("Watched").includes(e);t.dataset.watched=n,t.textContent=n?"remove from watched":"add to watched"}}function Ac(e,t){if(null!==localStorage.getItem("Queue")){const n=localStorage.getItem("Queue").includes(e);t.dataset.queue=n,t.textContent=n?"remove from queue":"add to queue"}}function Pc(e,t,n){"library"===e.target.closest("body").getAttribute("data-weblocation")&&(E.innerHTML="",Cc(n),t.setAttribute("disabled",!0))}function Dc(){y.classList.add("modal-open"),document.body.style.overflow="hidden",document.body.classList.add("modal-open"),y.addEventListener("click",Mc),document.addEventListener("keydown",xc),document.querySelector(".modal__btn-closs").addEventListener("click",Uc)}function xc(e){"Escape"===e.key&&Uc()}function Mc(e){e.target===y&&Uc()}function Uc(){y.firstElementChild.classList.remove("team-modal"),y.firstElementChild.classList.add("modal"),y.classList.remove("modal-open"),document.body.style.overflow="overlay",document.body.classList.remove("modal-open"),document.removeEventListener("keydown",xc),y.removeEventListener("keydown",Mc),y.firstElementChild.dataset.id="",v.innerHTML=""}p&&p.addEventListener("click",Nc),E&&E.addEventListener("click",Nc),w.addEventListener("click",(function(e){e.preventDefault(),y.firstElementChild.innerHTML="",Bc.innerHTML="",qc.innerHTML="",y.firstElementChild.insertAdjacentElement("beforeend",qc),qc.classList.add("team-modal__title"),qc.insertAdjacentHTML("beforeend","Cinematics GO IT JS #48"),y.firstElementChild.insertAdjacentElement("beforeend",Bc),y.firstElementChild.insertAdjacentHTML("beforeend",Fc),Bc.classList.add("team-modal__list"),n(kc).map((e=>{const t=`<li class="team-modal__item">\n\t\t<img src="${e.img}" class="team-modal__pic">\n\t\t<h2 class="team-modal__name">${e.name}</h2>\n    <p class="team-modal__role">${e.role}</p>\n\t\t<div>\n\t\t<a href="${e.git}" target="_blank" class="team-modal__link">\n      <svg \n        xmlns="http://www.w3.org/2000/svg" \n        width="24" \n        height="24" \n        viewBox="0 0 24 24"\n      >\n        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"\n        />\n      </svg>\n\t\t</a>\n\t\t</div>\n\t\t</li>`;Bc.insertAdjacentHTML("beforeend",t)})),Dc(),y.firstElementChild.classList.add("team-modal"),y.firstElementChild.classList.remove("modal")}));const Fc='\n<button class="modal__btn-closs btn__closs-modal">\n      <svg\n        xmlns="http://www.w3.org/2000/svg"\n        width="14"\n        height="14"\n        fill="currentColor"\n        class="bi bi-x-lg"\n        viewBox="0 0 16 16"\n      >\n        <path\n          d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"\n        />\n      </svg>\n    </button>\n',Bc=document.createElement("ul"),qc=document.createElement("h1");(async(e=1)=>{const{data:t}=await n(gc).get(`/trending/movie/week?api_key=119d79b053f922516c6af4b71b0fd3ac&page=${e}`);return t})(1).then((e=>{wc(e),o("moviesData",e.results)}));const jc=async(e="",t="",i="",r="",s="")=>{let a={year:""!==r&&"start"!==r?`&primary_release_year=${r}`:"",genre:""!==i&&"start"!==i?`&with_genres=${i}`:"",queryFetch:`&query=${t}`,sort:""!==s&&"start"!==s?`&sort_by=${s}`:"",discover:"/trending",week:"/week"};""===t&&(a.queryFetch=""),""!==t&&""===i&&(a.discover="/search",a.week=""),""===t&&""!==i&&(a.discover="/discover",a.week=""),""===t&&""!==r&&(a.discover="/discover",a.week="");let{data:l}=await n(gc).get(`${a.discover}/movie${a.week}?api_key=119d79b053f922516c6af4b71b0fd3ac${a.genre}${a.year}${a.sort}&language=en-US${a.queryFetch}&page=${e}`);return o("moviesData",l.results),l};f&&f.addEventListener("submit",(function(e){e.preventDefault(),Qc="",document.querySelector("#genreForm").classList.add("is-hidden"),document.querySelector("#sortForm").classList.add("is-hidden"),Kc=1,$c.classList.add("is-hidden");const{searchMovie:t}=e.currentTarget;Yc=t.value.toLowerCase().trim(),o("query-pg",Yc),""==Yc?(Hc.classList.add("is-hidden"),th(),f.reset()):(nh(),f.reset(),Hc.classList.remove("is-hidden"));(async(e,t)=>{const{data:i}=await n(gc).get(`/search/movie?api_key=119d79b053f922516c6af4b71b0fd3ac&language=en-US&query=${e}&page=${t}`);return i})(Yc,Kc).then((e=>{if(c(e),Jc=e.total_pages,o("total-pages",Jc),eh(Jc),1===Jc)$c.classList.add("is-hidden"),G.innerHTML='<li class="page active">1</li>',Wc.classList.add("is-hidden");else if(Jc>1&&Jc<6){G.innerHTML="";for(let e=1;e<=Jc;e++)G.insertAdjacentHTML("beforeend",`<li class="page">${e}</li>`),G.children[0].classList.add("active")}else G.children[8].textContent=Jc;e.results.length<1||""===Yc?(th(),f.reset(),Hc.classList.add("is-hidden"),Yc="",o("query-pg",Yc)):(nh(),wc(e),f.reset(),Hc.classList.remove("is-hidden"))}))}));const $c=document.querySelector(".page-btn.prev"),Wc=document.querySelector(".page-btn.next"),Hc=document.querySelector(".pagination-section"),Vc=document.querySelector(".to_main__link"),zc={filterForm:document.querySelector("#filter-form"),sortForm:document.querySelector("#sortForm"),genreForm:document.querySelector("#genreForm"),yearForm:document.querySelector("#yearForm"),btnReset:document.querySelector("#btnResetFilter")};Vc&&Vc.addEventListener("click",(e=>{Gc=1,o("page-pg",Gc)})),zc.genreForm&&zc.genreForm.addEventListener("input",(function(e){e&&(Wc.classList.remove("is-hidden"),Qc=e.target.value,Gc=1,o("page-pg",Gc),o("genre-pg",Qc),jc(Gc,Yc,Qc,Xc,Zc).then((e=>{wc(e),Jc=e.total_pages>500?500:e.total_pages,eh(Jc),o("total-pages",Jc)})))})),zc.yearForm&&zc.yearForm.addEventListener("input",(function(e){e&&(Gc=1,o("page-pg",Gc),Xc=e.target.value,o("year-pg",Xc),jc(Gc,Yc,Qc,Xc,Zc).then((e=>{if(wc(e),Jc=e.total_pages>500?500:e.total_pages,eh(Jc),o("total-pages",Jc),1===Jc)$c.classList.add("is-hidden"),G.innerHTML='<li class="page active">1</li>',Wc.classList.add("is-hidden");else if(Jc>1&&Jc<6){G.innerHTML="",Wc.classList.remove("is-hidden");for(let e=1;e<=Jc;e++)G.insertAdjacentHTML("beforeend",`<li class="page">${e}</li>`),G.children[0].classList.add("active")}else G.children[8].textContent=Jc})))})),zc.sortForm&&zc.sortForm.addEventListener("input",(function(e){e&&(Gc=1,o("page-pg",Gc),Zc=e.target.value,o("sort-pg",Zc),jc(Gc,Yc,Qc,Xc,Zc).then((e=>{wc(e),Jc=e.total_pages>500?500:e.total_pages,eh(Jc),o("total-pages",Jc)})))})),$c&&$c.classList.add("is-hidden"),zc.btnReset&&zc.btnReset.addEventListener("click",(function(e){Wc.classList.remove("is-hidden"),e.preventDefault(),zc.filterForm[0].options.selectedIndex=0,zc.filterForm[1].options.selectedIndex=0,zc.filterForm[2].options.selectedIndex=0,Qc="",Xc="",Zc="",Gc=1,""===Yc&&(Jc=1e3);o("genre-pg",Qc),o("year-pg",Xc),o("sort-pg",Zc),o("page-pg",Gc),o("total-pages",Jc),jc(Gc,Yc,Qc,Xc,Zc).then((e=>{wc(e),c(e),o("total-pages",Jc)})),o("page-pg",Gc),eh(Jc)})),T.addEventListener("click",(function(){Jc=1e3,o("page-pg",1),o("genre-pg",""),o("year-pg",""),o("total-pages",Jc),o("query-pg",""),o("sort-pg",""),jc(Gc,Yc,Qc,Xc,Zc).then((e=>{wc(e),c(e),o("total-pages",Jc)}))})),a("total-pages")||o("total-pages",1e3),a("page-pg")||o("page-pg",1);let Kc=1,Gc=a("page-pg"),Jc=a("total-pages"),Yc=a("query-pg"),Qc=a("genre-pg"),Xc=a("year-pg"),Zc=a("sort-pg");function eh(e){$c.classList.add("is-hidden"),G.innerHTML=`\t<li class="page is-hidden">1</li>\n\t<li class="dots is-hidden">...</li>\n\t<li class="page active">1</li>\n\t<li class="page">2</li>\n\t<li class="page">3</li>\n\t<li class="page">4</li>\n\t<li class="page">5</li>\n\t<li class="dots">...</li>\n\t<li class="page">${e}</li>`}function th(){_.classList.remove("visually-hidden"),p.classList.add("visually-hidden"),b.classList.add("visually-hidden")}function nh(){_.classList.add("visually-hidden"),p.classList.remove("visually-hidden"),b.classList.remove("visually-hidden")}function ih(){!function(){const e=document.querySelector("body").classList.contains("dark"),t=document.querySelector(".btn-to-top");e?t.classList.add("btn-to-top--dark"):t.classList.remove("btn-to-top--dark")}();const e=window.pageYOffset,t=document.documentElement.clientHeight;e>t&&m.classList.add("btn-to-top--visible"),e<=t&&m&&m.classList.remove("btn-to-top--visible")}function rh(){window.pageYOffset>0&&window.scrollTo({top:0,behavior:"smooth"})}Wc&&(Wc.addEventListener("click",(function(){Gc==Jc-1&&Wc.classList.add("is-hidden");1==Gc&&$c.classList.remove("is-hidden");Jc>1&&Jc<6?(G.children[Gc].classList.add("active"),G.children[Gc-1].classList.remove("active"),Gc+=1):(Gc<3?(Gc+=1,G.children[Gc+1].classList.add("active"),G.children[Gc].classList.remove("active")):Gc>=3&&(Gc+=1,Gc<=Jc-2&&(G.children[0].classList.remove("is-hidden"),G.children[1].classList.remove("is-hidden"),G.children[2].textContent=Gc-2,G.children[3].textContent=Gc-1,G.children[4].textContent=Gc,G.children[5].textContent=Gc+1,G.children[6].textContent=Gc+2),Gc>=Jc-2&&(G.children[7].classList.add("is-hidden"),G.children[8].classList.add("is-hidden")),Gc==Jc-1&&(G.children[4].classList.remove("active"),G.children[5].classList.add("active"))),Gc==Jc&&(G.children[5].classList.remove("active"),G.children[6].classList.add("active")));jc(Gc,Yc,Qc,Xc,Zc).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),wc(e),c(e)})),o("page-pg",Gc)})),$c.addEventListener("click",(function(){Gc==Jc&&Wc.classList.remove("is-hidden");2==Gc&&$c.classList.add("is-hidden");Jc>1&&Jc<6?(G.children[Gc-2].classList.add("active"),G.children[Gc-1].classList.remove("active"),Gc-=1):(Gc<4?(Gc-=1,G.children[Gc+1].classList.add("active"),G.children[Gc+2].classList.remove("active")):Gc>=3&&Gc<Jc-2&&(Gc-=1,G.children[2].textContent=Gc-2,G.children[3].textContent=Gc-1,G.children[4].textContent=Gc,G.children[5].textContent=Gc+1,G.children[6].textContent=Gc+2,3==Gc&&(G.children[0].classList.add("is-hidden"),G.children[1].classList.add("is-hidden"))),Gc==Jc-2?(Gc-=1,G.children[7].classList.remove("is-hidden"),G.children[8].classList.remove("is-hidden"),G.children[2].textContent=Gc-2,G.children[3].textContent=Gc-1,G.children[4].textContent=Gc,G.children[5].textContent=Gc+1,G.children[6].textContent=Gc+2):Gc==Jc-1?(Gc-=1,G.children[4].classList.add("active"),G.children[5].classList.remove("active")):Gc==Jc&&(Gc-=1,G.children[5].classList.add("active"),G.children[6].classList.remove("active")));jc(Gc,Yc,Qc,Xc,Zc).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),wc(e),c(e)})),o("page-pg",Gc)})),G.addEventListener("click",(function(e){"page"==e.target.className&&function(e){Gc=parseInt(e.target.textContent),Jc>1&&Jc<6?(G.children[Gc-1].classList.remove("active"),G.children[Gc-1].classList.add("active")):(1==Gc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page active">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`:2==Gc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page active">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`:3==Gc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page active">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`:Gc>3&&(Gc<=Jc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Gc-2}</li>\n\t\t\t<li class="page">${Gc-1}</li>\n\t\t\t<li class="page active">${Gc}</li>\n\t\t\t<li class="page">${Gc+1}</li>\n\t\t\t<li class="page">${Gc+2}</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`),Gc>=Jc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Gc-2}</li>\n\t\t\t<li class="page">${Gc-1}</li>\n\t\t\t<li class="page active">${Gc}</li>\n\t\t\t<li class="page">${Gc+1}</li>\n\t\t\t<li class="page">${Gc+2}</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page is-hidden">${Jc}</li>`),Gc==Jc-1&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Jc-4}</li>\n\t\t\t\t<li class="page">${Jc-3}</li>\n\t\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t\t<li class="page active">${Jc-1}</li>\n\t\t\t\t<li class="page">${Jc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Jc}</li>`)),Gc==Jc&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Jc-4}</li>\n\t\t\t\t<li class="page">${Jc-3}</li>\n\t\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t\t<li class="page">${Jc-1}</li>\n\t\t\t\t<li class="page active">${Jc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Jc}</li>`));Gc==Jc?Wc.classList.add("is-hidden"):Wc.classList.remove("is-hidden");1==Gc?$c.classList.add("is-hidden"):$c.classList.remove("is-hidden");jc(Gc,Yc,Qc,Xc,Zc).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),wc(e),c(e)})),o("page-pg",Gc)}(e)}))),"library.html"!=location.pathname.split("/").slice(-1)&&(jc(Gc,Yc,Qc,Xc,Zc).then((e=>{wc(e),c(e),o("total-pages",Jc),Yc&&(document.querySelector("#genreForm").classList.add("is-hidden"),document.querySelector("#sortForm").classList.add("is-hidden"))})),o("page-pg",Gc),Jc>1&&Jc<6?(G.children[Gc-1].classList.remove("active"),G.children[Gc-1].classList.add("active")):(1==Gc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page active">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`:2==Gc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page active">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`:3==Gc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page active">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`:Gc>3&&(Gc<=Jc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Gc-2}</li>\n\t\t\t<li class="page">${Gc-1}</li>\n\t\t\t<li class="page active">${Gc}</li>\n\t\t\t<li class="page">${Gc+1}</li>\n\t\t\t<li class="page">${Gc+2}</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc}</li>`),Gc>=Jc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Gc-2}</li>\n\t\t\t<li class="page">${Gc-1}</li>\n\t\t\t<li class="page active">${Gc}</li>\n\t\t\t<li class="page">${Gc+1}</li>\n\t\t\t<li class="page">${Gc+2}</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page is-hidden">${Jc}</li>`),Gc==Jc-1&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Jc-4}</li>\n\t\t\t\t<li class="page">${Jc-3}</li>\n\t\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t\t<li class="page active">${Jc-1}</li>\n\t\t\t\t<li class="page">${Jc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Jc}</li>`)),Gc==Jc&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Jc-4}</li>\n\t\t\t\t<li class="page">${Jc-3}</li>\n\t\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t\t<li class="page">${Jc-1}</li>\n\t\t\t\t<li class="page active">${Jc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Jc}</li>`)),Gc==Jc?Wc.classList.add("is-hidden"):Wc.classList.remove("is-hidden"),1==Gc?$c.classList.add("is-hidden"):$c.classList.remove("is-hidden")),document.body.onload=function(){setTimeout((function(){if(document.getElementById("page-preloader")){const e=document.getElementById("page-preloader");e.classList.contains("done")||e.classList.add("done")}}),500)},window.addEventListener("scroll",ih),m&&m.addEventListener("click",rh),ih(),rh();const sh=document.getElementById("toggle-theme-btn"),oh=document.querySelector(".sun"),ah=document.querySelector(".moon"),lh=a("theme")?a("theme"):"light";o("theme",lh),document.body.classList.add(lh),"light"===lh?oh.style.visibility="hidden":ah.style.visibility="hidden",sh.addEventListener("click",(()=>{"light"===a("theme")?(document.body.classList.add("dark"),"library.html"!=location.pathname.split("/").slice(-1)&&document.querySelector(".pagination-section").classList.add("dark"),document.querySelector(".modal").classList.add("dark"),ah.style.visibility="hidden",oh.style.visibility="visible",o("theme","dark")):(document.body.classList.remove("dark"),"library.html"!=location.pathname.split("/").slice(-1)&&document.querySelector(".pagination-section").classList.remove("dark"),document.querySelector(".modal").classList.remove("dark"),oh.style.visibility="hidden",ah.style.visibility="visible",o("theme","light"))})),"library.html"!=location.pathname.split("/").slice(-1)&&"dark"===a("theme")&&document.querySelector(".pagination-section").classList.add("dark");
//# sourceMappingURL=index.95dc086d.js.map
