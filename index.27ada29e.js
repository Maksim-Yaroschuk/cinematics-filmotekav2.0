 ...
 * limitations under the License.
 */
function(e=Rt()){const t=Ct(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ct(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Oe(n.getOptions(),null!=t?t:{}))return e;Ro(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:nc,persistence:[vl,rl,ol]})}();let ac;var lc,cc,hc;function uc(e){e.preventDefault();const t=document.querySelector("#name_1").value,n=document.querySelector("#email_1").value,i=document.querySelector("#password").value;!1!==fc(n)&&!1!==gc(i)?(Za(oc,n,i).then((e=>{const i=e.user;mo(fo(sc,"users/"+i.uid),{username:t,email:n}),Y(),O.reset(),alert("User Created")})).catch((function(e){e.code;const t=e.message;alert(t)})),ac=oc.currentUser):alert("Email or Password is Outta Line!")}function dc(e){e.preventDefault();const t=document.querySelector("#email_1").value,n=document.querySelector("#password").value;!1!==fc(t)&&!1!==gc(n)?(el(oc,t,n).then((e=>{const t=e.user,n=new Date;_o(fo(sc,"users/"+t.uid),{last_login:n}),Y(),O.reset(),pc(),alert("User loged in")})).catch((e=>{e.code;const t=e.message;alert(t)})),ac=oc.currentUser):alert("Email or Password is Outta Line!")}function pc(){C&&k&&(C.classList.add("visually-hidden"),k.classList.remove("visually-hidden"))}function fc(e){return!0===/^[^@]+@\w+(\.\w+)+\w$/.test(e)}function gc(e){return!(e.length<6)}O&&O.addEventListener("submit",dc),q&&(q.onchange=function(){this.checked?(j.classList.remove("disabled_for_signUp"),j.removeAttribute("disabled")):(j.classList.add("disabled_for_signUp"),j.setAttribute("disabled","disabled"))}),W&&H.addEventListener("click",(function(){A.classList.add("visually-hidden"),P.classList.remove("visually-hidden"),D.classList.remove("visually-hidden"),B.classList.remove("visually-hidden"),$.classList.add("visually-hidden"),j.classList.remove("visually-hidden"),W.classList.add("visually-hidden"),V.classList.remove("visually-hidden"),O.addEventListener("submit",uc),O.removeEventListener("submit",dc)})),V&&z.addEventListener("click",(function(){A.classList.remove("visually-hidden"),P.classList.add("visually-hidden"),D.classList.add("visually-hidden"),B.classList.add("visually-hidden"),$.classList.remove("visually-hidden"),j.classList.add("visually-hidden"),W.classList.remove("visually-hidden"),V.classList.add("visually-hidden"),O.addEventListener("submit",dc),O.removeEventListener("submit",uc)})),lc=e=>{if(e){const t=e.uid;console.log(t),pc()}else C&&k&&(C.classList.remove("visually-hidden"),k.classList.add("visually-hidden"))},We(oc).onAuthStateChanged(lc,cc,hc),K&&K.addEventListener("click",(e=>{tl(oc).then((()=>{alert("User loged out")})).catch((e=>{e.code;const t=e.message;alert(t)}))}));var mc;mc=s("bRlFp");n(mc).defaults.baseURL="https://api.themoviedb.org/3";const _c=async()=>{const{data:e}=await n(mc).get("/genre/movie/list?api_key=119d79b053f922516c6af4b71b0fd3ac");return e},vc=a("genresList"),yc=({poster_path:e,popularity:t,vote_average:n,vote_count:i,original_title:r,genre_ids:s,overview:o})=>{let a="";return a=e?`https://image.tmdb.org/t/p/w400/${e}`:"https://i.ibb.co/GPMFHG6/keep-calm-poster-not-found-1.png",`\n<button class="modal__btn-closs btn__closs-modal">\n      <svg\n        xmlns="http://www.w3.org/2000/svg"\n        width="14"\n        height="14"\n        fill="currentColor"\n        class="bi bi-x-lg"\n        viewBox="0 0 16 16"\n      >\n        <path\n          d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"\n        />\n      </svg>\n    </button>\n<div class="modal__movi-poster">\n<img src="${a}" alt="placeholder" />\n</div>\n\n<div class="modal_movi-info">\n<h2 class="modal__title">${r}</h2>\n\n<div class="modal__info-card info-card">\n  <ul class="info-card__list-parametrs">\n    <li class="info-card__item info-card__item-paramter">Vote / Votes</li>\n    <li class="info-card__item info-card__item-point">\n      <span>${n.toFixed(1)}</span> <span>/</span> <span>${i}</span>\n    </li>\n    <li class="info-card__item info-card__item-paramter">Popularity</li>\n    <li class="info-card__item info-card__item-point">${t.toFixed(1)}</li>\n    <li class="info-card__item info-card__item-paramter">Original Title</li>\n    <li class="info-card__item info-card__item-point">${r}</li>\n    <li class="info-card__item info-card__item-paramter">Genre</li>\n    <li class="info-card__item info-card__item-point">${(e=>{const t=[];return e.map((e=>{vc.map((n=>{e===n.id&&t.push(n.name)}))})),t.join(", ")})(s)}</li>\n  </ul>\n  \n</div>\n\n<div class="modal__about">\n  <h3 class="modal__about-title">ABOUT </h3>\n  <p class="modal__about-text">\n    ${o}\n  </p>\n</div>\n<div class="modal__buttons">\n      <button type="button" class="modal__add-watched" data-watched='false' data-liery='false'>add to watched</button>\n      <button type="button" class="modal__add-queue" data-queue='false' data-liery='false'>add to queue</button>\n      \n    </div>\n   <div class='trailerBtnWrap'> <button class="trailerBtn"></button></div>\n  \n    </div>\n    </div>`};async function wc(){return{genres:await _c().then((({genres:e})=>e))}}function bc(e){wc().then((({genres:t})=>{o("genresList",t),e.results&&e.results.forEach((e=>{const{genre_ids:n,release_date:i}=e;t.forEach((({name:t,id:r})=>{n.includes(r)&&(n.length>2&&n.splice(2,n.length-1,"Other"),n.splice(n.indexOf(r),1,t)),e.genre_names=n.join(", "),e.release_date&&(e.release_date=i.slice(0,4))}))}));const n=Ic(e.results);p&&(p.innerHTML=n)}))}function Ic(e){if(e)return e.map((({original_title:e,poster_path:t,overview:n,vote_average:i,id:r,genre_names:s,release_date:o})=>{let a="";return a=t?`https://image.tmdb.org/t/p/w400/${t}`:"https://i.ibb.co/GPMFHG6/keep-calm-poster-not-found-1.png",`<li class='poster-list__item' key='${r}'>\n            <img\n              class='poster-list__img'\n              src='${a}'\n              alt='${e}'\n              width\n              loading='lazy'\n            />\n            <span class='poster-list__rate'>${i.toFixed(1)}</span>\n            <div class='poster-list__wrap'>\n              <h2 class='poster-list__title'>${e}</h2>\n              <div class='poster-list__info'>\n                <p class='poster-list__text'>${s}</p>\n                <p class='poster-list__age'>| ${o}</p>\n              </div>\n            </div>\n          </li>`})).join("")}function Ec(e){wc().then((({genres:t})=>{o("genresList",t),e.results&&e.results.forEach((e=>{const{genre_ids:n,release_date:i}=e;t.forEach((({name:t,id:r})=>{n.includes(r)&&(n.length>2&&n.splice(2,n.length-1,"Other"),n.splice(n.indexOf(r),1,t)),e.genre_names=n.join(", "),e.release_date&&(e.release_date=i.slice(0,4))}))}));const n=Ic(e.results);E&&(E.innerHTML=n)}))}const Tc=document.querySelector(".btn--watched"),Cc=document.querySelector(".btn--queue");if(null!==Tc){Tc.addEventListener("click",(()=>{kc("Watched")})),Cc.addEventListener("click",(()=>{kc("Queue")}));const e=a("Watched")?a("Watched"):[],t=a("Queue")?a("Queue"):[];(t||e)&&t>e?document.addEventListener("DOMContentLoaded",(()=>{kc("Queue")})):document.addEventListener("DOMContentLoaded",(()=>{kc("Watched")}))}function kc(e){"Queue"===e?(Cc.classList.add("btn-orange"),Tc.classList.remove("btn-orange")):(Cc.classList.remove("btn-orange"),Tc.classList.add("btn-orange")),E.classList.remove("list-empty"),E.innerHTML="";let t=e+"Data";const n=a(e);if(!n||!n.length)return function(e){const t=a(e)?a(e):[];if("Queue"===e?(Cc.classList.add("btn-orange"),Tc.classList.remove("btn-orange")):(Cc.classList.remove("btn-orange"),Tc.classList.add("btn-orange")),t){E.classList.add("list-empty");const t=`\n\t\t<div class='list-empty__shild blink'>\n\t\t\t<h3 class= 'list-empty__title'>Your ${n=e} list is empty!</h3>\n\t\t\t<p class='blink' >to add a movie to the ${n} list, click the corresponding button in the poster window</p>\n\t</div>`;E.innerHTML=t}var n}(e),console.log("ваш список пуст!");Ec({results:a(t)})}var Sc;Sc=JSON.parse('[{"name":"Maksim Yaroschuk","role":"Team Lead","git":"https://github.com/Maksim-Yaroschuk","img":"https://avatars.githubusercontent.com/u/79583144?v=4"},{"name":"Dmytro Kravchenko","role":"Scrum Master","git":"https://github.com/pixelboyXL","img":"https://avatars.githubusercontent.com/u/94831587?v=4"},{"name":"Eduard Tsikota","role":"Developer","git":"https://github.com/ts4ed","img":"https://avatars.githubusercontent.com/u/103256726?v=4"},{"name":"Andrey Tkachenko","role":"Developer","git":"https://github.com/TkachAn","img":"https://avatars.githubusercontent.com/u/61586895?v=4"},{"name":"Raya Shcherban","role":"Developer","git":"https://github.com/Raisiya","img":"https://avatars.githubusercontent.com/u/90385588?v=4"},{"name":"Dimitri Suhak","role":"Developer","git":"https://github.com/dimaniagara","img":"https://avatars.githubusercontent.com/u/86453739?v=4"},{"name":"Alina Marunchak","role":"Developer","git":"https://github.com/AlinaMrk","img":"https://avatars.githubusercontent.com/u/96976728?v=4"},{"name":"Denys Yeremenko","role":"Developer","git":"https://github.com/DenysYeremenko","img":"https://avatars.githubusercontent.com/u/95313654?v=4"},{"name":"Yevhenii Lymarenko","role":"Developer","git":"https://github.com/YevheniiLi","img":"https://avatars.githubusercontent.com/u/96422034?v=4"},{"name":"Yevhen Lytvynchuk","role":"Developer","git":"https://github.com/evglitik","img":"https://avatars.githubusercontent.com/u/95911893?v=4"},{"name":"Yevhen Chernytskyi","role":"Developer","git":"https://github.com/zhekichaan","img":"https://avatars.githubusercontent.com/u/100925349?v=4"}]');const Rc=async e=>{let t="";return await(async e=>{const{data:t}=await n(mc).get(`/movie/${e}/videos?api_key=119d79b053f922516c6af4b71b0fd3ac`);return t.results.filter((e=>{if("YouTube"===e.site)return e}))})(e).then((e=>t=`https://www.youtube.com/embed/${e[0].key}`)).catch((e=>t=!1)),t};async function Lc(e){const t=Number(e.target.getAttribute("key"));document.querySelector(".trailerBtn").setAttribute("disabled",!0),await Rc(t).then((e=>{e?(v.firstElementChild.insertAdjacentHTML("beforeend",`<iframe id="ytplayer" type="text/html" width="782" height="360"\n      src="${e}"\n      frameborder="0"/>`),document.querySelector("#ytplayer").scrollIntoView({block:"center",behavior:"smooth"})):(v.firstElementChild.insertAdjacentHTML("beforeend",'<div class="trailer-placeholder"></div>'),document.querySelector(".trailer-placeholder").scrollIntoView({block:"center",behavior:"smooth"}))}))}function Nc(e){const t=document.querySelector(".trailerBtn");t.setAttribute("key",e),t.addEventListener("click",Lc)}const Oc=document.querySelector("body").getAttribute("data-weblocation"),Ac=document.querySelector(".btn--watched");function Pc(e){"library"===Oc&&(Ac.classList.contains("btn-orange")?(moviesData=JSON.parse(localStorage.getItem("WatchedData")),console.log(moviesData)):(moviesData=JSON.parse(localStorage.getItem("QueueData")),console.log(moviesData)));const t=e.target.closest("li");if(t){const e=Number(t.getAttribute("key")),n=moviesData.find((t=>t.id===e));!function(e){v.firstElementChild.innerHTML=yc(e)}(n),Uc(),document.querySelector("body").classList.contains("dark")?v.firstElementChild.classList.add("modal-dark"):v.firstElementChild.classList.remove("modal-dark"),v.firstElementChild.dataset.id=n.id,function(){const e=document.querySelector(".modal__add-watched"),t=document.querySelector(".modal__add-queue"),n=Number(v.firstElementChild.dataset.id);"library"===Oc&&function(e,t){Ac.classList.contains("btn-orange")?(e.dataset.liery=!0,t.dataset.liery=!1):(e.dataset.liery=!1,t.dataset.liery=!0)}(e,t);null!==localStorage.getItem("Watched")&&Dc(n,e);null!==localStorage.getItem("Queue")&&xc(n,t);e.addEventListener("click",(t=>{l(n,"Watched"),Mc(t,e,"Watched"),Dc(n,e)})),t.addEventListener("click",(e=>{l(n,"Queue"),Mc(e,t,"Queue"),xc(n,t)}))}(),Nc(e)}}function Dc(e,t){if(null!==localStorage.getItem("Watched")){const n=localStorage.getItem("Watched").includes(e);t.dataset.watched=n,t.textContent=n?"remove from watched":"add to watched"}}function xc(e,t){if(null!==localStorage.getItem("Queue")){const n=localStorage.getItem("Queue").includes(e);t.dataset.queue=n,t.textContent=n?"remove from queue":"add to queue"}}function Mc(e,t,n){"library"===e.target.closest("body").getAttribute("data-weblocation")&&(E.innerHTML="",kc(n),t.setAttribute("disabled",!0))}function Uc(){v.classList.add("modal-open"),document.body.style.overflow="hidden",document.body.classList.add("modal-open"),m.classList.remove("btn-to-top--visible"),v.addEventListener("click",Bc),document.addEventListener("keydown",Fc),document.querySelector(".modal__btn-closs").addEventListener("click",qc)}function Fc(e){"Escape"===e.key&&qc()}function Bc(e){e.target===v&&qc()}function qc(){v.firstElementChild.classList.remove("team-modal"),v.firstElementChild.classList.add("modal"),v.classList.remove("modal-open"),document.body.style.overflow="overlay",document.body.classList.remove("modal-open"),document.removeEventListener("keydown",Fc),v.removeEventListener("keydown",Bc),v.firstElementChild.dataset.id="",y.innerHTML="",m.classList.add("btn-to-top--visible")}p&&p.addEventListener("click",Pc),E&&E.addEventListener("click",Pc),w.addEventListener("click",(function(e){e.preventDefault(),v.firstElementChild.innerHTML="",$c.innerHTML="",Wc.innerHTML="",v.firstElementChild.insertAdjacentElement("beforeend",Wc),Wc.classList.add("team-modal__title"),Wc.insertAdjacentHTML("beforeend","Cinematics GO IT JS #48"),v.firstElementChild.insertAdjacentElement("beforeend",$c),v.firstElementChild.insertAdjacentHTML("beforeend",jc),$c.classList.add("team-modal__list"),n(Sc).map((e=>{const t=`<li class="team-modal__item">\n\t\t<img src="${e.img}" class="team-modal__pic">\n\t\t<h2 class="team-modal__name">${e.name}</h2>\n    <p class="team-modal__role">${e.role}</p>\n\t\t<div>\n\t\t<a href="${e.git}" target="_blank" class="team-modal__link">\n      <svg \n        xmlns="http://www.w3.org/2000/svg" \n        width="24" \n        height="24" \n        viewBox="0 0 24 24"\n      >\n        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"\n        />\n      </svg>\n\t\t</a>\n\t\t</div>\n\t\t</li>`;$c.insertAdjacentHTML("beforeend",t)})),Uc(),v.firstElementChild.classList.add("team-modal"),v.firstElementChild.classList.remove("modal")}));const jc='\n<button class="modal__btn-closs btn__closs-modal">\n      <svg\n        xmlns="http://www.w3.org/2000/svg"\n        width="14"\n        height="14"\n        fill="currentColor"\n        class="bi bi-x-lg"\n        viewBox="0 0 16 16"\n      >\n        <path\n          d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"\n        />\n      </svg>\n    </button>\n',$c=document.createElement("ul"),Wc=document.createElement("h1");(async(e=1)=>{const{data:t}=await n(mc).get(`/trending/movie/week?api_key=119d79b053f922516c6af4b71b0fd3ac&page=${e}`);return t})(1).then((e=>{bc(e),o("moviesData",e.results)}));const Hc=async(e="",t="",i="",r="",s="")=>{let a={year:""!==r&&"start"!==r?`&primary_release_year=${r}`:"",genre:""!==i&&"start"!==i?`&with_genres=${i}`:"",queryFetch:`&query=${t}`,sort:""!==s&&"start"!==s?`&sort_by=${s}`:"",discover:"/trending",week:"/week"};""===t&&(a.queryFetch=""),""!==t&&""===i&&(a.discover="/search",a.week=""),""===t&&""!==i&&(a.discover="/discover",a.week=""),""===t&&""!==r&&(a.discover="/discover",a.week="");let{data:l}=await n(mc).get(`${a.discover}/movie${a.week}?api_key=119d79b053f922516c6af4b71b0fd3ac${a.genre}${a.year}${a.sort}&language=en-US${a.queryFetch}&page=${e}`);return o("moviesData",l.results),l};f&&f.addEventListener("submit",(function(e){J.classList.remove("done"),e.preventDefault(),eh="",document.querySelector("#genreForm").classList.add("is-hidden"),document.querySelector("#sortForm").classList.add("is-hidden"),Yc=1,Vc.classList.add("is-hidden"),zc.classList.remove("is-hidden");const{searchMovie:t}=e.currentTarget;Zc=t.value.toLowerCase().trim(),o("query-pg",Zc),""==Zc?(Kc.classList.add("is-hidden"),rh(),f.reset(),J.classList.add("done")):(sh(),f.reset(),Kc.classList.remove("is-hidden"));(async(e,t)=>{const{data:i}=await n(mc).get(`/search/movie?api_key=119d79b053f922516c6af4b71b0fd3ac&language=en-US&query=${e}&page=${t}`);return i})(Zc,Yc).then((e=>{if(c(e),Xc=e.total_pages,o("total-pages",Xc),ih(Xc),J.classList.add("done"),1===Xc)Vc.classList.add("is-hidden"),G.innerHTML='<li class="page active">1</li>',zc.classList.add("is-hidden");else if(Xc>1&&Xc<6){G.innerHTML="";for(let e=1;e<=Xc;e++)G.insertAdjacentHTML("beforeend",`<li class="page">${e}</li>`),G.children[0].classList.add("active")}else G.children[8].textContent=Xc;e.results.length<1||""===Zc?(rh(),f.reset(),Kc.classList.add("is-hidden"),Zc="",o("query-pg",Zc),J.classList.add("done")):(sh(),bc(e),f.reset(),Kc.classList.remove("is-hidden"))}))}));const Vc=document.querySelector(".page-btn.prev"),zc=document.querySelector(".page-btn.next"),Kc=document.querySelector(".pagination-section"),Gc=document.querySelector(".to_main__link"),Jc={filterForm:document.querySelector("#filter-form"),sortForm:document.querySelector("#sortForm"),genreForm:document.querySelector("#genreForm"),yearForm:document.querySelector("#yearForm"),btnReset:document.querySelector("#btnResetFilter")};Gc&&Gc.addEventListener("click",(e=>{Qc=1,o("page-pg",Qc)})),Jc.genreForm&&Jc.genreForm.addEventListener("input",(function(e){e&&(J.classList.remove("done"),zc.classList.remove("is-hidden"),eh=e.target.value,Qc=1,o("page-pg",Qc),o("genre-pg",eh),Hc(Qc,Zc,eh,th,nh).then((e=>{bc(e),Xc=e.total_pages>500?500:e.total_pages,ih(Xc),o("total-pages",Xc),J.classList.add("done")})))})),Jc.yearForm&&Jc.yearForm.addEventListener("input",(function(e){e&&(J.classList.remove("done"),Qc=1,o("page-pg",Qc),th=e.target.value,o("year-pg",th),Hc(Qc,Zc,eh,th,nh).then((e=>{if(bc(e),Xc=e.total_pages>500?500:e.total_pages,ih(Xc),J.classList.add("done"),""==Zc&&o("total-pages",Xc),1===Xc)Vc.classList.add("is-hidden"),G.innerHTML='<li class="page active">1</li>',zc.classList.add("is-hidden");else if(Xc>1&&Xc<6){G.innerHTML="",zc.classList.remove("is-hidden");for(let e=1;e<=Xc;e++)G.insertAdjacentHTML("beforeend",`<li class="page">${e}</li>`),G.children[0].classList.add("active")}else G.children[8].textContent=Xc})))})),Jc.sortForm&&Jc.sortForm.addEventListener("input",(function(e){e&&(J.classList.remove("done"),Qc=1,o("page-pg",Qc),nh=e.target.value,o("sort-pg",nh),Hc(Qc,Zc,eh,th,nh).then((e=>{bc(e),Xc=e.total_pages>500?500:e.total_pages,ih(Xc),o("total-pages",Xc),J.classList.add("done")})))})),Vc&&Vc.classList.add("is-hidden"),Jc.btnReset&&Jc.btnReset.addEventListener("click",(function(e){J.classList.remove("done"),zc.classList.remove("is-hidden"),e.preventDefault(),Jc.filterForm[0].options.selectedIndex=0,Jc.filterForm[1].options.selectedIndex=0,Jc.filterForm[2].options.selectedIndex=0,eh="",th="",nh="",Qc=1,Xc=""===Zc?1e3:a("total-pages");o("genre-pg",eh),o("year-pg",th),o("sort-pg",nh),o("page-pg",Qc),o("total-pages",Xc),Hc(Qc,Zc,eh,th,nh).then((e=>{bc(e),c(e),o("total-pages",Xc),J.classList.add("done")})),o("page-pg",Qc),ih(Xc)})),T.addEventListener("click",(function(e){Xc=1e3,Qc=1,eh="",th="",Zc="",nh="",o("page-pg",Qc),o("genre-pg",eh),o("year-pg",th),o("total-pages",Xc),o("query-pg",Zc),o("sort-pg",nh)})),a("total-pages")||o("total-pages",1e3),a("page-pg")||o("page-pg",1);let Yc=1,Qc=a("page-pg"),Xc=a("total-pages"),Zc=a("query-pg"),eh=a("genre-pg"),th=a("year-pg"),nh=a("sort-pg");function ih(e){Vc.classList.add("is-hidden"),G.innerHTML=`\t<li class="page is-hidden">1</li>\n\t<li class="dots is-hidden">...</li>\n\t<li class="page active">1</li>\n\t<li class="page">2</li>\n\t<li class="page">3</li>\n\t<li class="page">4</li>\n\t<li class="page">5</li>\n\t<li class="dots">...</li>\n\t<li class="page">${e}</li>`}function rh(){_.classList.remove("visually-hidden"),p.classList.add("visually-hidden"),b.classList.add("visually-hidden")}function sh(){_.classList.add("visually-hidden"),p.classList.remove("visually-hidden"),b.classList.remove("visually-hidden")}function oh(){!function(){const e=document.querySelector("body").classList.contains("dark"),t=document.querySelector(".btn-to-top");e?t.classList.add("btn-to-top--dark"):t.classList.remove("btn-to-top--dark")}();const e=window.pageYOffset,t=document.documentElement.clientHeight;e>t&&m.classList.add("btn-to-top--visible"),e<=t&&m&&m.classList.remove("btn-to-top--visible")}function ah(){window.pageYOffset>0&&window.scrollTo({top:0,behavior:"smooth"})}zc&&(zc.addEventListener("click",(function(){J.classList.remove("done"),Qc==Xc-1&&zc.classList.add("is-hidden");1==Qc&&Vc.classList.remove("is-hidden");Xc>1&&Xc<6?(G.children[Qc].classList.add("active"),G.children[Qc-1].classList.remove("active"),Qc+=1):(Qc<3?(Qc+=1,G.children[Qc+1].classList.add("active"),G.children[Qc].classList.remove("active")):Qc>=3&&(Qc+=1,Qc<=Xc-2&&(G.children[0].classList.remove("is-hidden"),G.children[1].classList.remove("is-hidden"),G.children[2].textContent=Qc-2,G.children[3].textContent=Qc-1,G.children[4].textContent=Qc,G.children[5].textContent=Qc+1,G.children[6].textContent=Qc+2),Qc>=Xc-2&&(G.children[7].classList.add("is-hidden"),G.children[8].classList.add("is-hidden")),Qc==Xc-1&&(G.children[4].classList.remove("active"),G.children[5].classList.add("active"))),Qc==Xc&&(G.children[5].classList.remove("active"),G.children[6].classList.add("active")));Hc(Qc,Zc,eh,th,nh).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),bc(e),c(e),J.classList.add("done")})),o("page-pg",Qc)})),Vc.addEventListener("click",(function(){J.classList.remove("done"),Qc==Xc&&zc.classList.remove("is-hidden");2==Qc&&Vc.classList.add("is-hidden");Xc>1&&Xc<6?(G.children[Qc-2].classList.add("active"),G.children[Qc-1].classList.remove("active"),Qc-=1):(Qc<4?(Qc-=1,G.children[Qc+1].classList.add("active"),G.children[Qc+2].classList.remove("active")):Qc>=3&&Qc<Xc-2&&(Qc-=1,G.children[2].textContent=Qc-2,G.children[3].textContent=Qc-1,G.children[4].textContent=Qc,G.children[5].textContent=Qc+1,G.children[6].textContent=Qc+2,3==Qc&&(G.children[0].classList.add("is-hidden"),G.children[1].classList.add("is-hidden"))),Qc==Xc-2?(Qc-=1,G.children[7].classList.remove("is-hidden"),G.children[8].classList.remove("is-hidden"),G.children[2].textContent=Qc-2,G.children[3].textContent=Qc-1,G.children[4].textContent=Qc,G.children[5].textContent=Qc+1,G.children[6].textContent=Qc+2):Qc==Xc-1?(Qc-=1,G.children[4].classList.add("active"),G.children[5].classList.remove("active")):Qc==Xc&&(Qc-=1,G.children[5].classList.add("active"),G.children[6].classList.remove("active")));Hc(Qc,Zc,eh,th,nh).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),bc(e),c(e),J.classList.add("done")})),o("page-pg",Qc)})),G.addEventListener("click",(function(e){"page"==e.target.className&&function(e){J.classList.remove("done"),Qc=parseInt(e.target.textContent),Xc>1&&Xc<6?(G.children[Qc-1].classList.remove("active"),G.children[Qc-1].classList.add("active")):(1==Qc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page active">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`:2==Qc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page active">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`:3==Qc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page active">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`:Qc>3&&(Qc<=Xc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Qc-2}</li>\n\t\t\t<li class="page">${Qc-1}</li>\n\t\t\t<li class="page active">${Qc}</li>\n\t\t\t<li class="page">${Qc+1}</li>\n\t\t\t<li class="page">${Qc+2}</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`),Qc>=Xc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Qc-2}</li>\n\t\t\t<li class="page">${Qc-1}</li>\n\t\t\t<li class="page active">${Qc}</li>\n\t\t\t<li class="page">${Qc+1}</li>\n\t\t\t<li class="page">${Qc+2}</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page is-hidden">${Xc}</li>`),Qc==Xc-1&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Xc-4}</li>\n\t\t\t\t<li class="page">${Xc-3}</li>\n\t\t\t\t<li class="page">${Xc-2}</li>\n\t\t\t\t<li class="page active">${Xc-1}</li>\n\t\t\t\t<li class="page">${Xc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Xc}</li>`)),Qc==Xc&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Xc-4}</li>\n\t\t\t\t<li class="page">${Xc-3}</li>\n\t\t\t\t<li class="page">${Xc-2}</li>\n\t\t\t\t<li class="page">${Xc-1}</li>\n\t\t\t\t<li class="page active">${Xc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Xc}</li>`));Qc==Xc?zc.classList.add("is-hidden"):zc.classList.remove("is-hidden");1==Qc?Vc.classList.add("is-hidden"):Vc.classList.remove("is-hidden");Hc(Qc,Zc,eh,th,nh).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),bc(e),c(e),J.classList.add("done")})),o("page-pg",Qc)}(e)}))),"library.html"==location.pathname.split("/").slice(-1)&&(Xc=1e3,Qc=1,eh="",th="",Zc="",nh="",o("page-pg",Qc),o("genre-pg",eh),o("year-pg",th),o("total-pages",Xc),o("query-pg",Zc),o("sort-pg",nh)),"library.html"!=location.pathname.split("/").slice(-1)&&(J.classList.remove("done"),Hc(Qc,Zc,eh,th,nh).then((e=>{bc(e),c(e),o("total-pages",Xc),J.classList.add("done"),Zc&&(document.querySelector("#genreForm").classList.add("is-hidden"),document.querySelector("#sortForm").classList.add("is-hidden"))})),o("page-pg",Qc),Xc>1&&Xc<6?(G.children[Qc-1].classList.remove("active"),G.children[Qc-1].classList.add("active")):(1==Qc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page active">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`:2==Qc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page active">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`:3==Qc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page active">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`:Qc>3&&(Qc<=Xc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Qc-2}</li>\n\t\t\t<li class="page">${Qc-1}</li>\n\t\t\t<li class="page active">${Qc}</li>\n\t\t\t<li class="page">${Qc+1}</li>\n\t\t\t<li class="page">${Qc+2}</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Xc}</li>`),Qc>=Xc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Qc-2}</li>\n\t\t\t<li class="page">${Qc-1}</li>\n\t\t\t<li class="page active">${Qc}</li>\n\t\t\t<li class="page">${Qc+1}</li>\n\t\t\t<li class="page">${Qc+2}</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page is-hidden">${Xc}</li>`),Qc==Xc-1&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Xc-4}</li>\n\t\t\t\t<li class="page">${Xc-3}</li>\n\t\t\t\t<li class="page">${Xc-2}</li>\n\t\t\t\t<li class="page active">${Xc-1}</li>\n\t\t\t\t<li class="page">${Xc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Xc}</li>`)),Qc==Xc&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Xc-4}</li>\n\t\t\t\t<li class="page">${Xc-3}</li>\n\t\t\t\t<li class="page">${Xc-2}</li>\n\t\t\t\t<li class="page">${Xc-1}</li>\n\t\t\t\t<li class="page active">${Xc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Xc}</li>`)),Qc==Xc?zc.classList.add("is-hidden"):zc.classList.remove("is-hidden"),1==Qc?Vc.classList.add("is-hidden"):Vc.classList.remove("is-hidden")),window.addEventListener("scroll",oh),m&&m.addEventListener("click",ah),oh(),ah();const lh=document.getElementById("toggle-theme-btn"),ch=document.querySelector(".sun"),hh=document.querySelector(".moon"),uh=a("theme")?a("theme"):"light";o("theme",uh),document.body.classList.add(uh),"light"===uh?ch.style.visibility="hidden":hh.style.visibility="hidden",lh.addEventListener("click",(()=>{"light"===a("theme")?(document.body.classList.add("dark"),"library.html"!=location.pathname.split("/").slice(-1)&&document.querySelector(".pagination-section").classList.add("dark"),document.querySelector(".modal").classList.add("dark"),hh.style.visibility="hidden",ch.style.visibility="visible",o("theme","dark")):(document.body.classList.remove("dark"),"library.html"!=location.pathname.split("/").slice(-1)&&document.querySelector(".pagination-section").classList.remove("dark"),document.querySelector(".modal").classList.remove("dark"),ch.style.visibility="hidden",hh.style.visibility="visible",o("theme","light"))})),"library.html"!=location.pathname.split("/").slice(-1)&&"dark"===a("theme")&&document.querySelector(".pagination-section").classList.add("dark");
//# sourceMappingURL=index.27ada29e.js.map
