 ...
 * limitations under the License.
 */
function(e=Rt()){const t=Ct(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ct(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Oe(n.getOptions(),null!=t?t:{}))return e;Ro(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:nc,persistence:[vl,rl,ol]})}();let ac;var lc,cc,hc;function uc(e){e.preventDefault();const t=document.querySelector("#name_1").value,n=document.querySelector("#email_1").value,i=document.querySelector("#password").value;!1!==fc(n)&&!1!==gc(i)?(Za(oc,n,i).then((e=>{const i=e.user;mo(fo(sc,"users/"+i.uid),{username:t,email:n}),Y(),O.reset(),alert("User Created")})).catch((function(e){e.code;const t=e.message;alert(t)})),ac=oc.currentUser):alert("Email or Password is Outta Line!")}function dc(e){e.preventDefault();const t=document.querySelector("#email_1").value,n=document.querySelector("#password").value;!1!==fc(t)&&!1!==gc(n)?(el(oc,t,n).then((e=>{const t=e.user,n=new Date;_o(fo(sc,"users/"+t.uid),{last_login:n}),Y(),O.reset(),pc(),alert("User loged in")})).catch((e=>{e.code;const t=e.message;alert(t)})),ac=oc.currentUser):alert("Email or Password is Outta Line!")}function pc(){C&&k&&(C.classList.add("visually-hidden"),k.classList.remove("visually-hidden"))}function fc(e){return expression=/^[^@]+@\w+(\.\w+)+\w$/,!0===expression.test(e)}function gc(e){return!(e.length<6)}O&&O.addEventListener("submit",dc),q&&(q.onchange=function(){this.checked?(j.classList.remove("disabled_for_signUp"),j.removeAttribute("disabled")):(j.classList.add("disabled_for_signUp"),j.setAttribute("disabled","disabled"))}),W&&H.addEventListener("click",(function(){A.classList.add("visually-hidden"),P.classList.remove("visually-hidden"),D.classList.remove("visually-hidden"),B.classList.remove("visually-hidden"),$.classList.add("visually-hidden"),j.classList.remove("visually-hidden"),W.classList.add("visually-hidden"),V.classList.remove("visually-hidden"),O.addEventListener("submit",uc),O.removeEventListener("submit",dc)})),V&&z.addEventListener("click",(function(){A.classList.remove("visually-hidden"),P.classList.add("visually-hidden"),D.classList.add("visually-hidden"),B.classList.add("visually-hidden"),$.classList.remove("visually-hidden"),j.classList.add("visually-hidden"),W.classList.remove("visually-hidden"),V.classList.add("visually-hidden"),O.addEventListener("submit",dc),O.removeEventListener("submit",uc)})),lc=e=>{if(e){const t=e.uid;console.log(t),pc()}else C&&k&&(C.classList.remove("visually-hidden"),k.classList.add("visually-hidden"))},We(oc).onAuthStateChanged(lc,cc,hc),K&&K.addEventListener("click",(e=>{tl(oc).then((()=>{alert("User loged out")})).catch((e=>{e.code;const t=e.message;alert(t)}))}));var mc;mc=s("bRlFp");n(mc).defaults.baseURL="https://api.themoviedb.org/3";const _c=async()=>{const{data:e}=await n(mc).get("/genre/movie/list?api_key=119d79b053f922516c6af4b71b0fd3ac");return e},vc=a("genresList"),yc=({poster_path:e,popularity:t,vote_average:n,vote_count:i,original_title:r,genre_ids:s,overview:o})=>`\n<button class="modal__btn-closs btn__closs-modal">\n      <svg\n        xmlns="http://www.w3.org/2000/svg"\n        width="14"\n        height="14"\n        fill="currentColor"\n        class="bi bi-x-lg"\n        viewBox="0 0 16 16"\n      >\n        <path\n          d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"\n        />\n      </svg>\n    </button>\n<div class="modal__movi-poster">\n<img src="https://image.tmdb.org/t/p/w400/${e}" alt="placeholder" />\n</div>\n\n<div class="modal_movi-info">\n<h2 class="modal__title">${r}</h2>\n\n<div class="modal__info-card info-card">\n  <ul class="info-card__list-parametrs">\n    <li class="info-card__item info-card__item-paramter">Vote / Votes</li>\n    <li class="info-card__item info-card__item-point">\n      <span>${n.toFixed(1)}</span> <span>/</span> <span>${i}</span>\n    </li>\n    <li class="info-card__item info-card__item-paramter">Popularity</li>\n    <li class="info-card__item info-card__item-point">${t.toFixed(1)}</li>\n    <li class="info-card__item info-card__item-paramter">Original Title</li>\n    <li class="info-card__item info-card__item-point">${r}</li>\n    <li class="info-card__item info-card__item-paramter">Genre</li>\n    <li class="info-card__item info-card__item-point">${(e=>{const t=[];return e.map((e=>{vc.map((n=>{e===n.id&&t.push(n.name)}))})),t.join(", ")})(s)}</li>\n  </ul>\n  \n</div>\n\n<div class="modal__about">\n  <h3 class="modal__about-title">ABOUT </h3>\n  <p class="modal__about-text">\n    ${o}\n  </p>\n</div>\n<div class="modal__buttons">\n      <button type="button" class="modal__add-watched" data-watched='false' data-liery='false'>add to watched</button>\n      <button type="button" class="modal__add-queue" data-queue='false' data-liery='false'>add to queue</button>\n      \n    </div>\n   <div class='trailerBtnWrap'> <button class="trailerBtn"></button></div>\n  \n    </div>\n    </div>`;async function wc(){return{genres:await _c().then((({genres:e})=>e))}}function bc(e){wc().then((({genres:t})=>{o("genresList",t),e.results&&e.results.forEach((e=>{const{genre_ids:n,release_date:i}=e;t.forEach((({name:t,id:r})=>{n.includes(r)&&(n.length>2&&n.splice(2,n.length-1,"Other"),n.splice(n.indexOf(r),1,t)),e.genre_names=n.join(", "),e.release_date&&(e.release_date=i.slice(0,4))}))}));const n=Ic(e.results);p&&(p.innerHTML=n)}))}function Ic(e){if(e)return e.map((({original_title:e,poster_path:t,overview:n,vote_average:i,id:r,genre_names:s,release_date:o})=>`<li class='poster-list__item' key='${r}'>\n    <img\n      class='poster-list__img'\n      src='https://image.tmdb.org/t/p/w400${t}'\n      alt='${e}'\n      width\n      loading='lazy'\n    />\n    <span class='poster-list__rate'>${i.toFixed(1)}</span>\n    <div class='poster-list__wrap'>\n      <h2 class='poster-list__title'>${e}</h2>\n      <div class='poster-list__info'>\n        <p class='poster-list__text'>${s}</p>\n        <p class='poster-list__age'>| ${o}</p>\n      </div>\n    </div>\n  </li>`)).join("")}function Ec(e){wc().then((({genres:t})=>{o("genresList",t),e.results&&e.results.forEach((e=>{const{genre_ids:n,release_date:i}=e;t.forEach((({name:t,id:r})=>{n.includes(r)&&(n.length>2&&n.splice(2,n.length-1,"Other"),n.splice(n.indexOf(r),1,t)),e.genre_names=n.join(", "),e.release_date&&(e.release_date=i.slice(0,4))}))}));const n=Ic(e.results);E&&(E.innerHTML=n)})),o("moviesData",e.results)}const Tc=document.querySelector(".btn--watched"),Cc=document.querySelector(".btn--queue");if(null!==Tc){Tc.addEventListener("click",(()=>{kc("Watched")})),Cc.addEventListener("click",(()=>{kc("Queue")}));const e=a("Watched")?a("Watched"):[],t=a("Queue")?a("Queue"):[];(t||e)&&t>e?document.addEventListener("DOMContentLoaded",(()=>{kc("Queue")})):document.addEventListener("DOMContentLoaded",(()=>{kc("Watched")}))}function kc(e){"Queue"===e?(Cc.classList.add("btn-orange"),Tc.classList.remove("btn-orange")):(Cc.classList.remove("btn-orange"),Tc.classList.add("btn-orange")),E.classList.remove("list-empty"),E.innerHTML="";let t=e+"Data";const n=a(e);if(!n||!n.length)return function(e){const t=a(e)?a(e):[];if("Queue"===e?(Cc.classList.add("btn-orange"),Tc.classList.remove("btn-orange")):(Cc.classList.remove("btn-orange"),Tc.classList.add("btn-orange")),t){E.classList.add("list-empty");const t=`\n\t\t<div class='list-empty__shild blink'>\n\t\t\t<h3 class= 'list-empty__title'>Your ${n=e} list is empty!</h3>\n\t\t\t<p class='blink' >to add a movie to the ${n} list, click the corresponding button in the poster window</p>\n\t</div>`;E.innerHTML=t}var n}(e),console.log("ваш список пуст!");Ec({results:a(t)})}var Sc;Sc=JSON.parse('[{"name":"Maksim Yaroschuk","role":"Team Lead","git":"https://github.com/Maksim-Yaroschuk","img":"https://avatars.githubusercontent.com/u/79583144?v=4"},{"name":"Dmytro Kravchenko","role":"Scrum Master","git":"https://github.com/pixelboyXL","img":"https://avatars.githubusercontent.com/u/94831587?v=4"},{"name":"Eduard Tsikota","role":"Developer","git":"https://github.com/ts4ed","img":"https://avatars.githubusercontent.com/u/103256726?v=4"},{"name":"Andrey Tkachenko","role":"Developer","git":"https://github.com/TkachAn","img":"https://avatars.githubusercontent.com/u/61586895?v=4"},{"name":"Raya Shcherban","role":"Developer","git":"https://github.com/Raisiya","img":"https://avatars.githubusercontent.com/u/90385588?v=4"},{"name":"Dimitri Suhak","role":"Developer","git":"https://github.com/dimaniagara","img":"https://avatars.githubusercontent.com/u/86453739?v=4"},{"name":"Alina Marunchak","role":"Developer","git":"https://github.com/AlinaMrk","img":"https://avatars.githubusercontent.com/u/96976728?v=4"},{"name":"Denys Yeremenko","role":"Developer","git":"https://github.com/DenysYeremenko","img":"https://avatars.githubusercontent.com/u/95313654?v=4"},{"name":"Yevhenii Lymarenko","role":"Developer","git":"https://github.com/YevheniiLi","img":"https://avatars.githubusercontent.com/u/96422034?v=4"},{"name":"Yevhen Lytvynchuk","role":"Developer","git":"https://github.com/evglitik","img":"https://avatars.githubusercontent.com/u/95911893?v=4"},{"name":"Yevhen Chernytskyi","role":"Developer","git":"https://github.com/zhekichaan","img":"https://avatars.githubusercontent.com/u/100925349?v=4"}]');const Rc=async e=>{let t="";return await(async e=>{const{data:t}=await n(mc).get(`/movie/${e}/videos?api_key=119d79b053f922516c6af4b71b0fd3ac`);return t.results.filter((e=>{if("YouTube"===e.site)return e}))})(e).then((e=>t=`https://www.youtube.com/embed/${e[0].key}`)).catch((e=>t=!1)),t};async function Lc(e){const t=Number(e.target.getAttribute("key"));document.querySelector(".trailerBtn").setAttribute("disabled",!0),await Rc(t).then((e=>{e?(v.firstElementChild.insertAdjacentHTML("beforeend",`<iframe id="ytplayer" type="text/html" width="782" height="360"\n      src="${e}"\n      frameborder="0"/>`),document.querySelector("#ytplayer").scrollIntoView({block:"center",behavior:"smooth"})):(v.firstElementChild.insertAdjacentHTML("beforeend",'<div class="trailer-placeholder"></div>'),document.querySelector(".trailer-placeholder").scrollIntoView({block:"center",behavior:"smooth"}))}))}function Nc(e){const t=document.querySelector(".trailerBtn");t.setAttribute("key",e),t.addEventListener("click",Lc)}function Oc(e){const t=e.target.closest("li");if(t){const e=Number(t.getAttribute("key")),n=JSON.parse(localStorage.getItem("moviesData")).find((t=>t.id===e));!function(e){v.firstElementChild.innerHTML=yc(e)}(n),xc(),document.querySelector("body").classList.contains("dark")?v.firstElementChild.classList.add("modal-dark"):v.firstElementChild.classList.remove("modal-dark"),v.firstElementChild.dataset.id=n.id,function(){const e=document.querySelector(".modal__add-watched"),t=document.querySelector(".modal__add-queue"),n=Number(v.firstElementChild.dataset.id);"library"===document.querySelector("body").getAttribute("data-weblocation")&&function(e,t){document.querySelector(".btn--watched").classList.contains("btn-orange")?(e.dataset.liery=!0,t.dataset.liery=!1):(e.dataset.liery=!1,t.dataset.liery=!0)}(e,t);null!==localStorage.getItem("Watched")&&Ac(n,e);null!==localStorage.getItem("Queue")&&Pc(n,t);e.addEventListener("click",(t=>{l(n,"Watched"),Dc(t,e,"Watched"),Ac(n,e)})),t.addEventListener("click",(e=>{l(n,"Queue"),Dc(e,t,"Queue"),Pc(n,t)}))}(),Nc(e)}}function Ac(e,t){if(null!==localStorage.getItem("Watched")){const n=localStorage.getItem("Watched").includes(e);t.dataset.watched=n,t.textContent=n?"remove from watched":"add to watched"}}function Pc(e,t){if(null!==localStorage.getItem("Queue")){const n=localStorage.getItem("Queue").includes(e);t.dataset.queue=n,t.textContent=n?"remove from queue":"add to queue"}}function Dc(e,t,n){"library"===e.target.closest("body").getAttribute("data-weblocation")&&(E.innerHTML="",kc(n),t.setAttribute("disabled",!0))}function xc(){v.classList.add("modal-open"),document.body.style.overflow="hidden",document.body.classList.add("modal-open"),v.addEventListener("click",Uc),document.addEventListener("keydown",Mc),document.querySelector(".modal__btn-closs").addEventListener("click",Fc)}function Mc(e){"Escape"===e.key&&Fc()}function Uc(e){e.target===v&&Fc()}function Fc(){v.firstElementChild.classList.remove("team-modal"),v.firstElementChild.classList.add("modal"),v.classList.remove("modal-open"),document.body.style.overflow="overlay",document.body.classList.remove("modal-open"),document.removeEventListener("keydown",Mc),v.removeEventListener("keydown",Uc),v.firstElementChild.dataset.id="",y.innerHTML=""}p&&p.addEventListener("click",Oc),E&&E.addEventListener("click",Oc),w.addEventListener("click",(function(e){e.preventDefault(),v.firstElementChild.innerHTML="",qc.innerHTML="",jc.innerHTML="",v.firstElementChild.insertAdjacentElement("beforeend",jc),jc.classList.add("team-modal__title"),jc.insertAdjacentHTML("beforeend","Cinematics GO IT JS #48"),v.firstElementChild.insertAdjacentElement("beforeend",qc),v.firstElementChild.insertAdjacentHTML("beforeend",Bc),qc.classList.add("team-modal__list"),n(Sc).map((e=>{const t=`<li class="team-modal__item">\n\t\t<img src="${e.img}" class="team-modal__pic">\n\t\t<h2 class="team-modal__name">${e.name}</h2>\n    <p class="team-modal__role">${e.role}</p>\n\t\t<div>\n\t\t<a href="${e.git}" target="_blank" class="team-modal__link">\n      <svg \n        xmlns="http://www.w3.org/2000/svg" \n        width="24" \n        height="24" \n        viewBox="0 0 24 24"\n      >\n        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"\n        />\n      </svg>\n\t\t</a>\n\t\t</div>\n\t\t</li>`;qc.insertAdjacentHTML("beforeend",t)})),xc(),v.firstElementChild.classList.add("team-modal"),v.firstElementChild.classList.remove("modal")}));const Bc='\n<button class="modal__btn-closs btn__closs-modal">\n      <svg\n        xmlns="http://www.w3.org/2000/svg"\n        width="14"\n        height="14"\n        fill="currentColor"\n        class="bi bi-x-lg"\n        viewBox="0 0 16 16"\n      >\n        <path\n          d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"\n        />\n      </svg>\n    </button>\n',qc=document.createElement("ul"),jc=document.createElement("h1");(async(e=1)=>{const{data:t}=await n(mc).get(`/trending/movie/week?api_key=119d79b053f922516c6af4b71b0fd3ac&page=${e}`);return t})(1).then((e=>{bc(e),o("moviesData",e.results)}));const $c=async(e="",t="",i="",r="",s="")=>{let a={year:""!==r&&"start"!==r?`&primary_release_year=${r}`:"",genre:""!==i&&"start"!==i?`&with_genres=${i}`:"",queryFetch:`&query=${t}`,sort:""!==s&&"start"!==s?`&sort_by=${s}`:"",discover:"/trending",week:"/week"};""===t&&(a.queryFetch=""),""!==t&&""===i&&(a.discover="/search",a.week=""),""===t&&""!==i&&(a.discover="/discover",a.week=""),""===t&&""!==r&&(a.discover="/discover",a.week="");let{data:l}=await n(mc).get(`${a.discover}/movie${a.week}?api_key=119d79b053f922516c6af4b71b0fd3ac${a.genre}${a.year}${a.sort}&language=en-US${a.queryFetch}&page=${e}`);return o("moviesData",l.results),l};f&&f.addEventListener("submit",(function(e){J.classList.remove("done"),e.preventDefault(),Xc="",document.querySelector("#genreForm").classList.add("is-hidden"),document.querySelector("#sortForm").classList.add("is-hidden"),Gc=1,Wc.classList.add("is-hidden"),Hc.classList.remove("is-hidden");const{searchMovie:t}=e.currentTarget;Qc=t.value.toLowerCase().trim(),o("query-pg",Qc),""==Qc?(Vc.classList.add("is-hidden"),nh(),f.reset(),J.classList.add("done")):(ih(),f.reset(),Vc.classList.remove("is-hidden"));(async(e,t)=>{const{data:i}=await n(mc).get(`/search/movie?api_key=119d79b053f922516c6af4b71b0fd3ac&language=en-US&query=${e}&page=${t}`);return i})(Qc,Gc).then((e=>{if(c(e),Yc=e.total_pages,o("total-pages",Yc),th(Yc),J.classList.add("done"),1===Yc)Wc.classList.add("is-hidden"),G.innerHTML='<li class="page active">1</li>',Hc.classList.add("is-hidden");else if(Yc>1&&Yc<6){G.innerHTML="";for(let e=1;e<=Yc;e++)G.insertAdjacentHTML("beforeend",`<li class="page">${e}</li>`),G.children[0].classList.add("active")}else G.children[8].textContent=Yc;e.results.length<1||""===Qc?(nh(),f.reset(),Vc.classList.add("is-hidden"),Qc="",o("query-pg",Qc),J.classList.add("done")):(ih(),bc(e),f.reset(),Vc.classList.remove("is-hidden"))}))}));const Wc=document.querySelector(".page-btn.prev"),Hc=document.querySelector(".page-btn.next"),Vc=document.querySelector(".pagination-section"),zc=document.querySelector(".to_main__link"),Kc={filterForm:document.querySelector("#filter-form"),sortForm:document.querySelector("#sortForm"),genreForm:document.querySelector("#genreForm"),yearForm:document.querySelector("#yearForm"),btnReset:document.querySelector("#btnResetFilter")};zc&&zc.addEventListener("click",(e=>{Jc=1,o("page-pg",Jc)})),Kc.genreForm&&Kc.genreForm.addEventListener("input",(function(e){e&&(J.classList.remove("done"),Hc.classList.remove("is-hidden"),Xc=e.target.value,Jc=1,o("page-pg",Jc),o("genre-pg",Xc),$c(Jc,Qc,Xc,Zc,eh).then((e=>{bc(e),Yc=e.total_pages>500?500:e.total_pages,th(Yc),o("total-pages",Yc),J.classList.add("done")})))})),Kc.yearForm&&Kc.yearForm.addEventListener("input",(function(e){e&&(J.classList.remove("done"),Jc=1,o("page-pg",Jc),Zc=e.target.value,o("year-pg",Zc),$c(Jc,Qc,Xc,Zc,eh).then((e=>{if(bc(e),Yc=e.total_pages>500?500:e.total_pages,th(Yc),J.classList.add("done"),""==Qc&&o("total-pages",Yc),1===Yc)Wc.classList.add("is-hidden"),G.innerHTML='<li class="page active">1</li>',Hc.classList.add("is-hidden");else if(Yc>1&&Yc<6){G.innerHTML="",Hc.classList.remove("is-hidden");for(let e=1;e<=Yc;e++)G.insertAdjacentHTML("beforeend",`<li class="page">${e}</li>`),G.children[0].classList.add("active")}else G.children[8].textContent=Yc})))})),Kc.sortForm&&Kc.sortForm.addEventListener("input",(function(e){e&&(J.classList.remove("done"),Jc=1,o("page-pg",Jc),eh=e.target.value,o("sort-pg",eh),$c(Jc,Qc,Xc,Zc,eh).then((e=>{bc(e),Yc=e.total_pages>500?500:e.total_pages,th(Yc),o("total-pages",Yc),J.classList.add("done")})))})),Wc&&Wc.classList.add("is-hidden"),Kc.btnReset&&Kc.btnReset.addEventListener("click",(function(e){J.classList.remove("done"),Hc.classList.remove("is-hidden"),e.preventDefault(),Kc.filterForm[0].options.selectedIndex=0,Kc.filterForm[1].options.selectedIndex=0,Kc.filterForm[2].options.selectedIndex=0,Xc="",Zc="",eh="",Jc=1,Yc=""===Qc?1e3:a("total-pages");o("genre-pg",Xc),o("year-pg",Zc),o("sort-pg",eh),o("page-pg",Jc),o("total-pages",Yc),$c(Jc,Qc,Xc,Zc,eh).then((e=>{bc(e),c(e),o("total-pages",Yc),J.classList.add("done")})),o("page-pg",Jc),th(Yc)})),T.addEventListener("click",(function(){J.classList.remove("done"),Yc=1e3,o("page-pg",1),o("genre-pg",""),o("year-pg",""),o("total-pages",Yc),o("query-pg",""),o("sort-pg",""),$c(Jc,Qc,Xc,Zc,eh).then((e=>{bc(e),c(e),o("total-pages",Yc),J.classList.add("done")}))})),a("total-pages")||o("total-pages",1e3),a("page-pg")||o("page-pg",1);let Gc=1,Jc=a("page-pg"),Yc=a("total-pages"),Qc=a("query-pg"),Xc=a("genre-pg"),Zc=a("year-pg"),eh=a("sort-pg");function th(e){Wc.classList.add("is-hidden"),G.innerHTML=`\t<li class="page is-hidden">1</li>\n\t<li class="dots is-hidden">...</li>\n\t<li class="page active">1</li>\n\t<li class="page">2</li>\n\t<li class="page">3</li>\n\t<li class="page">4</li>\n\t<li class="page">5</li>\n\t<li class="dots">...</li>\n\t<li class="page">${e}</li>`}function nh(){_.classList.remove("visually-hidden"),p.classList.add("visually-hidden"),b.classList.add("visually-hidden")}function ih(){_.classList.add("visually-hidden"),p.classList.remove("visually-hidden"),b.classList.remove("visually-hidden")}function rh(){!function(){const e=document.querySelector("body").classList.contains("dark"),t=document.querySelector(".btn-to-top");e?t.classList.add("btn-to-top--dark"):t.classList.remove("btn-to-top--dark")}();const e=window.pageYOffset,t=document.documentElement.clientHeight;e>t&&m.classList.add("btn-to-top--visible"),e<=t&&m&&m.classList.remove("btn-to-top--visible")}function sh(){window.pageYOffset>0&&window.scrollTo({top:0,behavior:"smooth"})}Hc&&(Hc.addEventListener("click",(function(){J.classList.remove("done"),Jc==Yc-1&&Hc.classList.add("is-hidden");1==Jc&&Wc.classList.remove("is-hidden");Yc>1&&Yc<6?(G.children[Jc].classList.add("active"),G.children[Jc-1].classList.remove("active"),Jc+=1):(Jc<3?(Jc+=1,G.children[Jc+1].classList.add("active"),G.children[Jc].classList.remove("active")):Jc>=3&&(Jc+=1,Jc<=Yc-2&&(G.children[0].classList.remove("is-hidden"),G.children[1].classList.remove("is-hidden"),G.children[2].textContent=Jc-2,G.children[3].textContent=Jc-1,G.children[4].textContent=Jc,G.children[5].textContent=Jc+1,G.children[6].textContent=Jc+2),Jc>=Yc-2&&(G.children[7].classList.add("is-hidden"),G.children[8].classList.add("is-hidden")),Jc==Yc-1&&(G.children[4].classList.remove("active"),G.children[5].classList.add("active"))),Jc==Yc&&(G.children[5].classList.remove("active"),G.children[6].classList.add("active")));$c(Jc,Qc,Xc,Zc,eh).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),bc(e),c(e),J.classList.add("done")})),o("page-pg",Jc)})),Wc.addEventListener("click",(function(){J.classList.remove("done"),Jc==Yc&&Hc.classList.remove("is-hidden");2==Jc&&Wc.classList.add("is-hidden");Yc>1&&Yc<6?(G.children[Jc-2].classList.add("active"),G.children[Jc-1].classList.remove("active"),Jc-=1):(Jc<4?(Jc-=1,G.children[Jc+1].classList.add("active"),G.children[Jc+2].classList.remove("active")):Jc>=3&&Jc<Yc-2&&(Jc-=1,G.children[2].textContent=Jc-2,G.children[3].textContent=Jc-1,G.children[4].textContent=Jc,G.children[5].textContent=Jc+1,G.children[6].textContent=Jc+2,3==Jc&&(G.children[0].classList.add("is-hidden"),G.children[1].classList.add("is-hidden"))),Jc==Yc-2?(Jc-=1,G.children[7].classList.remove("is-hidden"),G.children[8].classList.remove("is-hidden"),G.children[2].textContent=Jc-2,G.children[3].textContent=Jc-1,G.children[4].textContent=Jc,G.children[5].textContent=Jc+1,G.children[6].textContent=Jc+2):Jc==Yc-1?(Jc-=1,G.children[4].classList.add("active"),G.children[5].classList.remove("active")):Jc==Yc&&(Jc-=1,G.children[5].classList.add("active"),G.children[6].classList.remove("active")));$c(Jc,Qc,Xc,Zc,eh).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),bc(e),c(e),J.classList.add("done")})),o("page-pg",Jc)})),G.addEventListener("click",(function(e){"page"==e.target.className&&function(e){J.classList.remove("done"),Jc=parseInt(e.target.textContent),Yc>1&&Yc<6?(G.children[Jc-1].classList.remove("active"),G.children[Jc-1].classList.add("active")):(1==Jc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page active">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`:2==Jc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page active">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`:3==Jc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page active">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`:Jc>3&&(Jc<=Yc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t<li class="page">${Jc-1}</li>\n\t\t\t<li class="page active">${Jc}</li>\n\t\t\t<li class="page">${Jc+1}</li>\n\t\t\t<li class="page">${Jc+2}</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`),Jc>=Yc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t<li class="page">${Jc-1}</li>\n\t\t\t<li class="page active">${Jc}</li>\n\t\t\t<li class="page">${Jc+1}</li>\n\t\t\t<li class="page">${Jc+2}</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page is-hidden">${Yc}</li>`),Jc==Yc-1&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Yc-4}</li>\n\t\t\t\t<li class="page">${Yc-3}</li>\n\t\t\t\t<li class="page">${Yc-2}</li>\n\t\t\t\t<li class="page active">${Yc-1}</li>\n\t\t\t\t<li class="page">${Yc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Yc}</li>`)),Jc==Yc&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Yc-4}</li>\n\t\t\t\t<li class="page">${Yc-3}</li>\n\t\t\t\t<li class="page">${Yc-2}</li>\n\t\t\t\t<li class="page">${Yc-1}</li>\n\t\t\t\t<li class="page active">${Yc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Yc}</li>`));Jc==Yc?Hc.classList.add("is-hidden"):Hc.classList.remove("is-hidden");1==Jc?Wc.classList.add("is-hidden"):Wc.classList.remove("is-hidden");$c(Jc,Qc,Xc,Zc,eh).then((e=>{window.scrollTo({top:100,behavior:"smooth"}),bc(e),c(e),J.classList.add("done")})),o("page-pg",Jc)}(e)}))),"library.html"!=location.pathname.split("/").slice(-1)&&(J.classList.remove("done"),$c(Jc,Qc,Xc,Zc,eh).then((e=>{bc(e),c(e),o("total-pages",Yc),J.classList.add("done"),Qc&&(document.querySelector("#genreForm").classList.add("is-hidden"),document.querySelector("#sortForm").classList.add("is-hidden"))})),o("page-pg",Jc),Yc>1&&Yc<6?(G.children[Jc-1].classList.remove("active"),G.children[Jc-1].classList.add("active")):(1==Jc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page active">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`:2==Jc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page active">2</li>\n\t\t\t<li class="page">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`:3==Jc?G.innerHTML=`\n\t\t\t<li class="page is-hidden">1</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="page">2</li>\n\t\t\t<li class="page active">3</li>\n\t\t\t<li class="page">4</li>\n\t\t\t<li class="page">5</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`:Jc>3&&(Jc<=Yc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t<li class="page">${Jc-1}</li>\n\t\t\t<li class="page active">${Jc}</li>\n\t\t\t<li class="page">${Jc+1}</li>\n\t\t\t<li class="page">${Jc+2}</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Yc}</li>`),Jc>=Yc-2&&(G.innerHTML=`\n\t\t\t<li class="page">1</li>\n\t\t\t<li class="dots">...</li>\n\t\t\t<li class="page">${Jc-2}</li>\n\t\t\t<li class="page">${Jc-1}</li>\n\t\t\t<li class="page active">${Jc}</li>\n\t\t\t<li class="page">${Jc+1}</li>\n\t\t\t<li class="page">${Jc+2}</li>\n\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t<li class="page is-hidden">${Yc}</li>`),Jc==Yc-1&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Yc-4}</li>\n\t\t\t\t<li class="page">${Yc-3}</li>\n\t\t\t\t<li class="page">${Yc-2}</li>\n\t\t\t\t<li class="page active">${Yc-1}</li>\n\t\t\t\t<li class="page">${Yc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Yc}</li>`)),Jc==Yc&&(G.innerHTML=`\n\t\t\t\t<li class="page">1</li>\n\t\t\t\t<li class="dots">...</li>\n\t\t\t\t<li class="page">${Yc-4}</li>\n\t\t\t\t<li class="page">${Yc-3}</li>\n\t\t\t\t<li class="page">${Yc-2}</li>\n\t\t\t\t<li class="page">${Yc-1}</li>\n\t\t\t\t<li class="page active">${Yc}</li>\n\t\t\t\t<li class="dots is-hidden">...</li>\n\t\t\t\t<li class="page is-hidden">${Yc}</li>`)),Jc==Yc?Hc.classList.add("is-hidden"):Hc.classList.remove("is-hidden"),1==Jc?Wc.classList.add("is-hidden"):Wc.classList.remove("is-hidden")),window.addEventListener("scroll",rh),m&&m.addEventListener("click",sh),rh(),sh();const oh=document.getElementById("toggle-theme-btn"),ah=document.querySelector(".sun"),lh=document.querySelector(".moon"),ch=a("theme")?a("theme"):"light";o("theme",ch),document.body.classList.add(ch),"light"===ch?ah.style.visibility="hidden":lh.style.visibility="hidden",oh.addEventListener("click",(()=>{"light"===a("theme")?(document.body.classList.add("dark"),"library.html"!=location.pathname.split("/").slice(-1)&&document.querySelector(".pagination-section").classList.add("dark"),document.querySelector(".modal").classList.add("dark"),lh.style.visibility="hidden",ah.style.visibility="visible",o("theme","dark")):(document.body.classList.remove("dark"),"library.html"!=location.pathname.split("/").slice(-1)&&document.querySelector(".pagination-section").classList.remove("dark"),document.querySelector(".modal").classList.remove("dark"),ah.style.visibility="hidden",lh.style.visibility="visible",o("theme","light"))})),"library.html"!=location.pathname.split("/").slice(-1)&&"dark"===a("theme")&&document.querySelector(".pagination-section").classList.add("dark");
//# sourceMappingURL=index.36ee9785.js.map
